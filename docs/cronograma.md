...
A partição da Aula 1 em blocos já está definida.

| Bloco | Tema |
| --- | --- |
| 1 | Arquitetura e papel do arquiteto |
| 2 | Qualidade e tipos de requisito |
| 3 | Cenários e significância arquitetural |
| 4 | Estilos arquiteturais |

## Blocos das aulas 2 a 6

A partição em blocos das aulas 2 a 6 ainda não foi definida pelo professor. As páginas de visão geral de cada módulo trazem essa informação assim que ela for publicada.
