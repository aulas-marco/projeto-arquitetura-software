...
Sobre as restrições, uma resposta forte identifica que a proibição de parar o sistema em período letivo, combinada com a ausência de janela de calendário para uma virada simultânea de todos os módulos, elimina a reescrita completa em uma única entrega. E identifica que a restrição segundo a qual o ambiente virtual de aprendizagem e o ERP financeiro permanecem, com o trabalho definido como integração e governança e não como substituição, é o que fecha a porta para a substituição por um produto de mercado, isoladamente, porque essa restrição já declara qual é o tipo de trabalho aceito antes de qualquer comparação de custo ou de funcionalidade entre produtos.
