...
- O formato de um registro de decisão arquitetural, ADR, com contexto, decisão e consequências, nos moldes de Nygard e de MADR
...
Nygard (2011), publicação de referência sobre registro de decisões de arquitetura em formato ADR, autora do formato mais citado na área.

MADR (sem data), especificação do formato alternativo Markdown Architectural Decision Records, mantida em repositório próprio.

Brown (sem data), especificação do modelo C4 para representação visual de arquitetura de software, mantida no site oficial do modelo.

A data de 2011 e a atribuição ao Cognitect Blog para Nygard não foram verificadas nesta rodada, apoiadas em conhecimento consolidado da área, não em fonte aberta consultada. A lista completa, com as fontes ainda em verificação, está na [bibliografia](../referencia/bibliografia.md) do curso.
