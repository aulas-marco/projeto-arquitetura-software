...
O [bloco 1](bloco-1-registro-de-decisao-arquitetural.md) expõe o conceito de registro de decisão arquitetural, o ADR, nos formatos de Nygard e de MADR. O exercício 5 desse bloco escreve a ADR que registra a escolha de estilo arquitetural já feita no exercício do [bloco 4 da Aula 1](../modulo-1-fundamentos/bloco-4-estilos-arquiteturais.md), sem introduzir extrato novo do caso. O produto desse exercício é uma ADR completa sobre uma decisão que o aluno já tomou, o que libera o tempo do exercício para praticar o formato, não para reler dado do caso.

O [bloco 2](bloco-2-plataforma-arquitetural.md) expõe o conceito de plataforma arquitetural e sua relação com o estilo já escolhido. O exercício 6 compara plataformas candidatas para o estilo escolhido na Aula 1, a partir de critérios explícitos apresentados no Conceito desse bloco. A comparação produzida aqui alimenta o bloco 3, porque a ADR de plataforma parte de uma escolha entre alternativas já justificada.

O [bloco 3](bloco-3-adr-de-plataforma.md) repete a prática de registrar uma decisão em formato de ADR, desta vez sobre a escolha de plataforma. O exercício 7 escreve a ADR que registra a escolha de plataforma feita no exercício 6 do bloco 2 desta aula, dando ao aluno uma segunda oportunidade de praticar o formato em contexto diferente do bloco 1.
